...
public class CadastrarLivroView extends javax.swing.JFrame {
    private final ILivroController livroController;
    private final Usuario usuario;
    
    public CadastrarLivroView(Usuario usuario) {
    ...
    private void cadastrarLivroButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarLivroButtonActionPerformed
        ...
        int idLivro = livroController.GetNovoId();
        ...
        livroController.CadastrarItem(livro);
        setVisible(false);
